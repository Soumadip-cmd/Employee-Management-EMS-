          ...
          <table className="table table-bordered tablestyle table-striped" >
            ...
            <tbody>
              <tr>
                ...
                <td >20-12-23</td>
                <td>
                  <span className="badge bg-success text-white  mx-1" style={{cursor:'pointer'}}>Approved</span>
                  <span className="badge bg-danger text-white mx-1"  style={{cursor:'pointer'}}>Reject</span>
                </td>
              </tr>
            </tbody>
          </table>

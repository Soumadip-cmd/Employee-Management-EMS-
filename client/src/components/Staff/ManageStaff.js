  ...
  return (
    <>
          ...
          <div className=" mt-2 pt-2">
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb">
                ...
                <li className="breadcrumb-item">
                  <NavLink to="/addStaff" className=" text-dark fw-semibold text-decoration-none">AddStaff</NavLink>
                </li>
              </ol>
            </nav>
          </div>
      ...
      <div className="bg-white     text-dark p-3 py-4 rounded-top rounded-bottom-1 shadow" style={{borderTop:'5px solid #004dffe8'}}>
        <h2 className="fs-4 fw-semibold mb-4 border-bottom pb-2">View Staff</h2>
          ...
          <table className="table table-bordered tablestyle table-striped" >
            ...
            <tbody>
              <tr>
                ...
                <td className="d-flex justify-content-center align-items-center h-100"><img className =" rounded-pill " src="https://placeholder.co/32x32" alt="img-Profile" /></td>

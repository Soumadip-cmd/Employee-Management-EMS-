    ...
    <div className="container-fluid">
      <Container className="mt-10">
        <div className="text-end mb-3">
          <Link to="/addStaff" className="btn btn-success mt-4">
            Add Staff
          </Link>
        </div>
        ...
        {loading ? (
          ...
          <div className="table-responsive rounded-top-2 " style={{borderTop:'5px solid rgba(0, 77, 255, 0.91)'}}>
            <table className="table table-striped  ">
              <thead>
                <tr>
                  ...
                  <th className="col px-5 text-center">Action</th>
                </tr>
              </thead>
              <tbody>
